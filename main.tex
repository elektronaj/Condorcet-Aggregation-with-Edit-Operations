...
\begin{definition}[Condorcet winners]
%
...
\begin{definition}[Closeness under inversion]
%
...
\begin{definition}[Freeness from local maxima]
%
...
\begin{remark}
%
Notice first that this example demonstrates that our Condorcet aggregation is not equal to maximizing social welfare:
